...
static const ClassTalentDef CLASS_TALENTS[NUM_CLASSES] = {
    ...
    [CLASS_WARRIOR] = { .trees = {
        ...
        { .name = "Arms", .color = CP_RED, .nodeCount = 15, .nodes = {
            ...
            NODE("Battle Cry",      "+2% phys dmg/rank",       1,2, 3, 0,-1, 0xFF, P(TB_PCT_PHYS_DMG,2),    NONE, NONE),
            /* T2: 10 pts in tree */
            NODE("Taste for Blood", "+3% crit dmg/rank",       2,0, 5, 0, 3, 0xFF, P(TB_PCT_CRIT_DMG,3),    NONE, NONE),
            NODE("Overpower",       "+2 STR +1 AGI/rank",      2,1, 5, 0,-1, 0xFF, P(TB_FLAT_STR,2),        P(TB_FLAT_AGI,1), NONE),
            NODE("Bladestorm",      "Active: 5x100% + immune", 2,2, 1, 1, 5, 1,    NONE,                    NONE, NONE),
            /* T3: 15 pts in tree */
            ...
            /* T4: 20 pts — capstone tier */
            NODE("Sweeping Strikes","Active: +50% dmg 5t",     4,0, 1, 1, 9, 2,    NONE,                    NONE, NONE),
            NODE("Executioner",     "+4% phys dmg/rank",       4,1, 3, 0,-1, 0xFF, P(TB_PCT_PHYS_DMG,4),    NONE, NONE),
            NODE("Titan's Grip",    "+5 STR +3% crit dmg/rank",4,2, 3, 0,-1, 0xFF, P(TB_FLAT_STR,5),        P(TB_PCT_CRIT_DMG,3), NONE),
        }},
        ...
        { .name = "Fury", .color = CP_YELLOW, .nodeCount = 15, .nodes = {
            ...
            NODE("Dual Wield Spec", "+3% crit dmg/rank",       1,2, 3, 0,-1, 0xFF, P(TB_PCT_CRIT_DMG,3),    NONE, NONE),
            ...
            NODE("Bloodsurge",      "+2 STR +1 VIT/rank",      2,2, 5, 0,-1, 0xFF, P(TB_FLAT_STR,2),        P(TB_FLAT_VIT,1), NONE),
            ...
            NODE("Recklessness",    "Active: +80% critDmg 5t", 4,1, 1, 1, 9, 2,    NONE,                    NONE, NONE),
            NODE("Annihilator",     "+5% phys dmg/rank",       4,0, 3, 0,-1, 0xFF, P(TB_PCT_PHYS_DMG,5),    NONE, NONE),
            NODE("Unhinged",        "+5 STR +3% atkSpd/rank",  4,2, 3, 0,-1, 0xFF, P(TB_FLAT_STR,5),        P(TB_PCT_ATKSPD,3), NONE),
        }},
        ...
        { .name = "Protection", .color = CP_CYAN, .nodeCount = 15, .nodes = {
            ...
            NODE("Defiance",        "+2% HP/rank",             1,2, 3, 0,-1, 0xFF, P(TB_PCT_HP,2),           NONE, NONE),
            NODE("One-Hand Spec",   "+2% phys dmg/rank",       2,0, 5, 0,-1, 0xFF, P(TB_PCT_PHYS_DMG,2),    NONE, NONE),
            NODE("Shield Wall",     "Active: shield 60% HP",   2,1, 1, 1, 3, 1,    NONE,                    NONE, NONE),
            NODE("Iron Will",       "+2 DEF +2 VIT/rank",      2,2, 5, 0, 2, 0xFF, P(TB_FLAT_DEF,2),        P(TB_FLAT_VIT,2), NONE),
            NODE("Vitality",        "+3% HP/rank",             3,0, 5, 0, 4, 0xFF, P(TB_PCT_HP,3),           NONE, NONE),
            ...
            NODE("Last Stand",      "Active: immune 2t+heal",  4,1, 1, 1, 9, 2,    NONE,                    NONE, NONE),
            NODE("Impenetrable",    "+4% armor +2% HP/rank",   4,0, 3, 0,-1, 0xFF, P(TB_PCT_ARMOR,4),       P(TB_PCT_HP,2), NONE),
            NODE("Juggernaut",      "+5 DEF +5 VIT/rank",      4,2, 3, 0,-1, 0xFF, P(TB_FLAT_DEF,5),        P(TB_FLAT_VIT,5), NONE),
        }},
    }},
    ...
    [CLASS_ROGUE] = { .trees = {
        ...
        { .name = "Assassination", .color = CP_GREEN, .nodeCount = 15, .nodes = {
            ...
            NODE("Improved Poisons","+3% crit dmg/rank",       1,2, 3, 0,-1, 0xFF, P(TB_PCT_CRIT_DMG,3),    NONE, NONE),
            ...
            NODE("Cold Blood",      "+2 AGI +1 STR/rank",      2,2, 5, 0,-1, 0xFF, P(TB_FLAT_AGI,2),        P(TB_FLAT_STR,1), NONE),
            ...
            NODE("Deathmark",       "Active: DoT+300% hit",    4,1, 1, 1, 9, 2,    NONE,                    NONE, NONE),
            NODE("Master Assassin", "+5% phys dmg/rank",       4,0, 3, 0,-1, 0xFF, P(TB_PCT_PHYS_DMG,5),    NONE, NONE),
            NODE("Kingsbane",       "+5 AGI +3% critDmg/rank", 4,2, 3, 0,-1, 0xFF, P(TB_FLAT_AGI,5),        P(TB_PCT_CRIT_DMG,3), NONE),
        }},
        ...
        { .name = "Outlaw", .color = CP_YELLOW, .nodeCount = 15, .nodes = {
            ...
            NODE("Evasion",         "+2 AGI +1 SPD/rank",      2,2, 5, 0,-1, 0xFF, P(TB_FLAT_AGI,2),        P(TB_FLAT_SPD,1), NONE),
            ...
            NODE("Blade Flurry",    "Active: 3x120% dmg",      4,1, 1, 1, 9, 2,    NONE,                    NONE, NONE),
            NODE("True Bearing",    "+5% phys dmg/rank",       4,0, 3, 0,-1, 0xFF, P(TB_PCT_PHYS_DMG,5),    NONE, NONE),
            NODE("Ace Up Sleeve",   "+5 AGI +4% atkSpd/rank",  4,2, 3, 0,-1, 0xFF, P(TB_FLAT_AGI,5),        P(TB_PCT_ATKSPD,4), NONE),
        }},
        ...
        { .name = "Subtlety", .color = CP_MAGENTA, .nodeCount = 15, .nodes = {
            ...
            NODE("Deeper Stratagem","+2 AGI +2% critDmg/r",    2,2, 5, 0,-1, 0xFF, P(TB_FLAT_AGI,2),        P(TB_PCT_CRIT_DMG,2), NONE),
            ...
            NODE("Death from Above","Active: 500% + stun",      4,1, 1, 1, 9, 2,    NONE,                    NONE, NONE),
            NODE("Perforated Veins","+5% crit dmg/rank",       4,0, 3, 0,-1, 0xFF, P(TB_PCT_CRIT_DMG,5),    NONE, NONE),
            NODE("Finality",        "+5 AGI +5% physDmg/rank", 4,2, 3, 0,-1, 0xFF, P(TB_FLAT_AGI,5),        P(TB_PCT_PHYS_DMG,5), NONE),
        }},
    }},
    ...
    [CLASS_MAGE] = { .trees = {
        ...
        { .name = "Fire", .color = CP_RED, .nodeCount = 15, .nodes = {
            ...
            NODE("Blazing Speed",   "+2% atk spd/rank",        1,2, 3, 0,-1, 0xFF, P(TB_PCT_ATKSPD,2),     NONE, NONE),
            ...
            NODE("World in Flames", "+2 INT +1 WIS/rank",      2,2, 5, 0,-1, 0xFF, P(TB_FLAT_INT,2),        P(TB_FLAT_WIS,1), NONE),
            ...
            NODE("Meteor",          "Active: 600% + stun 2t",  4,1, 1, 1, 9, 2,    NONE,                    NONE, NONE),
            NODE("Sun King's",      "+5% spell dmg/rank",      4,0, 3, 0,-1, 0xFF, P(TB_PCT_SPELL_DMG,5),   NONE, NONE),
            NODE("Inferno",         "+5 INT +3% critDmg/rank", 4,2, 3, 0,-1, 0xFF, P(TB_FLAT_INT,5),        P(TB_PCT_CRIT_DMG,3), NONE),
        }},
        ...
        { .name = "Frost", .color = CP_CYAN, .nodeCount = 15, .nodes = {
            ...
            NODE("Permafrost",      "+2% armor/rank",          1,0, 5, 0, 2, 0xFF, P(TB_PCT_ARMOR,2),       NONE, NONE),
            NODE("Brain Freeze",    "+1% crit/rank",           1,2, 5, 0,-1, 0xFF, P(TB_FLAT_CRIT,1),       NONE, NONE),
            ...
            NODE("Arctic Winds",    "+2 INT +2 WIS/rank",      2,2, 5, 0,-1, 0xFF, P(TB_FLAT_INT,2),        P(TB_FLAT_WIS,2), NONE),
            ...
            NODE("Glacial Spike",   "Active: 500% + stun 3t",  4,1, 1, 1, 9, 2,    NONE,                    NONE, NONE),
            NODE("Comet Storm",     "+5% spell dmg/rank",      4,0, 3, 0,-1, 0xFF, P(TB_PCT_SPELL_DMG,5),   NONE, NONE),
            NODE("Deep Freeze",     "+5 INT +3% armor/rank",   4,2, 3, 0,-1, 0xFF, P(TB_FLAT_INT,5),        P(TB_PCT_ARMOR,3), NONE),
        }},
        ...
        { .name = "Arcane", .color = CP_MAGENTA, .nodeCount = 15, .nodes = {
            ...
            NODE("Presence of Mind","+2% XP/rank",             1,2, 3, 0,-1, 0xFF, P(TB_PCT_XP,2),          NONE, NONE),
            ...
            NODE("Arcane Empow.",   "+2 INT +1 WIS/rank",      2,2, 5, 0,-1, 0xFF, P(TB_FLAT_INT,2),        P(TB_FLAT_WIS,1), NONE),
            ...
            NODE("Evocation",       "Active: heal 35%+mana60%",4,1, 1, 1, 9, 2,    NONE,                    NONE, NONE),
            NODE("Arcane Mastery",  "+5% spell dmg/rank",      4,0, 3, 0,-1, 0xFF, P(TB_PCT_SPELL_DMG,5),   NONE, NONE),
            NODE("Enlightenment",   "+5 INT +3% XP/rank",      4,2, 3, 0,-1, 0xFF, P(TB_FLAT_INT,5),        P(TB_PCT_XP,3), NONE),
        }},
    }},
    ...
    [CLASS_PRIEST] = { .trees = {
        ...
        { .name = "Shadow", .color = CP_MAGENTA, .nodeCount = 15, .nodes = {
            ...
            NODE("Misery",          "+2% atk spd/rank",        1,2, 3, 0,-1, 0xFF, P(TB_PCT_ATKSPD,2),     NONE, NONE),
            ...
            NODE("Vampiric Touch",  "+2 WIS +1 INT/rank",      2,2, 5, 0,-1, 0xFF, P(TB_FLAT_WIS,2),        P(TB_FLAT_INT,1), NONE),
            ...
            NODE("SW: Death",       "Active: 500% if <20%",     4,1, 1, 1, 9, 2,    NONE,                    NONE, NONE),
            NODE("Ancient Madness", "+5% spell dmg/rank",      4,0, 3, 0,-1, 0xFF, P(TB_PCT_SPELL_DMG,5),   NONE, NONE),
            NODE("Void Lord",       "+5 WIS +3% critDmg/rank", 4,2, 3, 0,-1, 0xFF, P(TB_FLAT_WIS,5),        P(TB_PCT_CRIT_DMG,3), NONE),
        }},
        ...
        { .name = "Discipline", .color = CP_YELLOW, .nodeCount = 15, .nodes = {
            ...
            NODE("Enlightenment",   "+2% XP/rank",             1,2, 3, 0,-1, 0xFF, P(TB_PCT_XP,2),          NONE, NONE),
            ...
            NODE("Borrowed Time",   "+2 WIS +2 INT/rank",      2,2, 5, 0,-1, 0xFF, P(TB_FLAT_WIS,2),        P(TB_FLAT_INT,2), NONE),
            ...
            NODE("Pain Suppression","Active: immune3t+heal20%", 4,1, 1, 1, 9, 2,    NONE,                    NONE, NONE),
            NODE("Strength of Soul","+5% heal/rank",           4,0, 3, 0,-1, 0xFF, P(TB_PCT_HEAL,5),        NONE, NONE),
            NODE("Clarity of Will", "+5 WIS +5 INT/rank",      4,2, 3, 0,-1, 0xFF, P(TB_FLAT_WIS,5),        P(TB_FLAT_INT,5), NONE),
        }},
        ...
        { .name = "Holy", .color = CP_WHITE, .nodeCount = 15, .nodes = {
            ...
            NODE("Inspiration",     "+2% HP/rank",             1,2, 3, 0,-1, 0xFF, P(TB_PCT_HP,2),           NONE, NONE),
            ...
            NODE("Spiritual Guide", "+2 WIS +2 VIT/rank",      2,2, 5, 0, 2, 0xFF, P(TB_FLAT_WIS,2),        P(TB_FLAT_VIT,2), NONE),
            ...
            NODE("Divine Hymn",     "Active: heal8%/t+immune",  4,1, 1, 1, 9, 2,    NONE,                    NONE, NONE),
            NODE("Circle of Healing","+5% heal/rank",          4,0, 3, 0,-1, 0xFF, P(TB_PCT_HEAL,5),        NONE, NONE),
            NODE("Apotheosis",      "+5 WIS +5 VIT/rank",      4,2, 3, 0,-1, 0xFF, P(TB_FLAT_WIS,5),        P(TB_FLAT_VIT,5), NONE),
        }},
    }},
};
