...
static const EnemyTemplate ENEMIES[TOTAL_ENEMIES] = {
    { "Goblin Grunt",   0,  45,  6, 2, 4,  21,  5, .008f,
      {"    ,   ,",  "   (o . o)", "    > v <",  "    /| |\\",  "     | |" }},
    { "Goblin Archer",  0,  38,  9, 1, 5,  23,  6, .008f,
      {"    ,   ,",  "   (- . -)~}", "    > ^ <",  "    /| |\\",  "     | |" }},
    { "Dire Wolf",      0,  35, 10, 1, 8,  18,  3, .006f,
      {"    /\\_/\\",  "   ( o.o )", "    > ^ <",  "   /|   |\\", "   ~ ~ ~ ~" }},
    { "Goblin Shaman",  0,  30, 12, 1, 3,  28,  8, .01f,
      {"   , ~ ,",   "  (@ . @) *", "   > ~ < |", "   /| |\\",   "    | |" }},
    { "Orc Scout",      0,  70,  8, 4, 4,  32, 10, .012f,
      {"     ___",   "  ,-/o o\\",  "  | (__) |", "  | /||\\ |", "   \\|  |/" }},

    { "Skeleton",       1,  80, 14, 4, 5,  48, 14, .008f,
      {"    _____",  "   / x x \\", "   |  ^  |", "    \\___/",   "    /| |\\" }},
    { "Zombie",         1, 110, 11, 6, 2,  52, 12, .008f,
      {"    _..._",  "   /x   \\~", "   | .  .|", "    \\_  _/",  "     |  |" }},
    { "Ghoul",          1,  90, 18, 3, 7,  57, 16, .01f,
      {"   /^  ^\\",  "  (  ..  )",  "   \\<  >/",  "   /|  |\\",  "  / |  | \\" }},
    { "Bone Mage",      1,  65, 22, 2, 4,  63, 20, .012f,
      {" *  _____  *","   / o o \\", "   | ___ |", "    \\___/",   "     | |" }},
    { "Crypt Wraith",   1,  70, 20, 1, 9,  67, 18, .014f,
      {"  ~(    )~", "  / o  o \\", "  | ==== |", "   \\    /",   "    ~~~~" }},

    { "Dark Knight",    2, 220, 28,18, 4,  109, 35, .01f,
      {"   _===_",   "  /|o  o|\\", "  ||_/\\_||", "  | [==] |", "  |_|  |_|" }},
    { "Gargoyle",       2, 180, 32,14, 6, 115, 38, .01f,
      {"   _/  \\_",  "  / o  o \\", "  \\  /\\  /", "   \\/  \\/",  "   |_/\\_|" }},
    { "Stone Golem",    2, 350, 24,25, 2, 126, 42, .012f,
      {"  [######]", "  |  ..  |",  "  | [==] |",  "  |  ||  |",  "  |__|__|" }},
    { "Shadow Archer",  2, 160, 36, 8, 8, 121, 40, .01f,
      {"    _/\\_",   "  /' .. '\\}","  |  ||  |", "  |  ||  |",  "   \\_||_/" }},
    { "Cursed Warden",  2, 280, 30,20, 3, 132, 45, .014f,
      {"  =[====]=", "  |  ><  |",  "  |_/||\\_|", "  | [  ] |",  "  |_|  |_|" }},

    { "Demon",          3, 400, 48,20, 6, 207, 70, .01f,
      {"   }\\  /{",  "  ( o  o )",  "  |\\ \\/ /|", "  |/ || \\|", "   \\_||_/" }},
    { "Shadow Lord",    3, 360, 55,15, 7, 230, 80, .012f,
      {" ~[======]~","  |  oo  |",  "  | \\  / |", "  |  \\/  |",  "  |______|" }},
    { "Imp Swarm",      3, 250, 42, 8,10, 195, 65, .008f,
      {" /\\ /\\ /\\", " oo oo oo",   " >< >< ><",  " || || ||",   " ~~ ~~ ~~" }},
    { "Pit Fiend",      3, 500, 52,22, 5, 253, 90, .014f,
      {" \\|/  \\|/",  " (  oo  )",   " |  /\\  |",  " | |  | |",  " |_|__|_|" }},
    { "Void Stalker",   3, 320, 60,12, 9, 241, 85, .012f,
      {"  ~.   .~",  " (  @ @  )",  "  \\ === /",   "   |   |",    "   ~   ~" }},

    { "Death Knight",   4, 600, 65,35, 5, 391,130, .012f,
      {"   _[==]_",  "  /|x  x|\\", "  || /\\ ||", "  |[====]|", "  |_|  |_|" }},
    { "Undead Dragon",  4, 900, 72,28, 6, 483,180, .014f,
      {" /\\   _/\\_", "/ \\\\=// \\",  "| | oo | |", " \\_\\ __ /_/","   |____|" }},
    { "Lich King",      4, 750, 80,20, 7, 552,200, .016f,
      {" ~{ /--\\ }~","  |(o)(o)|",  "  | \\__/ |", "  / |  | \\", "   \\|__|/" }},
    { "Bone Colossus",  4,1200, 60,40, 3, 460,160, .014f,
      {" _|[##]|_",  " ||| oo|||",  " ||| /\\|||", " |||_||_|||","_|_|  |_|_" }},
    { "Soul Reaver",    4, 550, 90,15,10, 529,190, .016f,
      {" ~{      }~","  ( @  @ )",  "  |\\-\"\"-/|", "   \\|  |/",  "    ~~~~" }},

    { "Goblin King",    0, 200, 25, 8, 3, 138, 60, .50f,
      {"   _/===\\_",  "  /|o  o|\\", "  | >ww< |",  "  |[KING]|",  "  |_|  |_|" }},
    { "Lord Ashvar",    1, 400, 49,12, 5, 345,120, .50f,
      {" ~{_/==\\_}~", "  | X  X |",  "  | \\==/ |",  "  |[BONE]|",  "  |__|__|" }},
    { "The Warden",     2, 700, 70,30, 4, 575,200, .50f,
      {" =[|/==\\|]=", "  || ** ||",  "  || /\\ ||",  "  |[WARD]|",  "  |_|__|_|" }},
    { "Abyssal Lord",   3,1000,105,28, 6, 920,350, .50f,
      {" }\\|/==\\|/{","  ( @  @ )",  "  |\\=/\\=/|", "  |[LORD]|",  "  |_|__|_|" }},
    { "The Lich God",   4,2000,154,45, 7,1725,700, .50f,
      {" ~{/====\\}~","  |(O)(O)|",  "  | \\==/ |",  "  |[LICH]|",  "  |_|__|_|" }},

    { "Magma Elemental", 5, 1200, 100, 35,  5,  713, 260, .01f,
      {"   .\\\\  //.",  " ~{ o  o }~",  "  \\\\\\==///",  "   \\\\||//",   "    ~~~~" }},
    { "Fire Imp",        5,  900, 120, 25,  8,  667, 240, .008f,
      {"   ^/  \\^",   " ~( ^^ )~",   "  ( || )",    "   \\/\\/",     "    ||" }},
    { "Lava Lurker",     5, 1500,  95, 45,  4,  805, 300, .01f,
      {"  ___===___",  " /  o o  \\",  " | /\\/\\ |",  "  \\ __ /",    "   |__|" }},
    { "Infernal Guard",  5, 1800, 110, 50,  4,  862, 320, .012f,
      {"  =[|##|]=",  " ~|| oo||~",  "  || /\\||",   "  |[==]|",    "  |_||_|" }},
    { "Scorched Wyvern", 5, 1100, 130, 28,  9,  782, 280, .014f,
      {" ^/\\__/\\^",  "/ \\\\><// \\", "|  \\\\//  |", " \\_\\/\\_/",   "   |__|" }},

    { "Frost Revenant",  6, 1800, 145, 50,  6, 1208, 420, .01f,
      {" ~*{    }*~",  "  ( ** )",    "  |\\  /|",   "   \\||/",     "    **" }},
    { "Ice Wraith",      6, 1400, 170, 35,  9,  1127, 400, .01f,
      {"  ~*   *~",   " ~( *  * )~",  "  \\ == /",    "   \\  /",     "    **" }},
    { "Glacial Golem",   6, 2800, 130, 70,  3, 1380, 500, .012f,
      {" *[####]*",   " *|*  *|*",   "  | [] |",    "  |_||_|",    " *|  |*" }},
    { "Frozen Archer",   6, 1500, 180, 40,  8, 1265, 450, .01f,
      {"   *_/\\_*",   " */' ''\\}*",  "  |* ||*|",   "  |  ||  |",  "   \\_||_/" }},
    { "Winter Knight",   6, 2200, 155, 60,  5, 1323, 480, .014f,
      {"  *[**]*",    " */|*  *|\\*", " *||_/\\_||*", "  |*[]*|",    "  |_|  |_|" }},

    { "Void Spawn",      7, 2800, 200, 65,  7, 1955, 680, .01f,
      {"  ~.    .~",  "  ( .  . )",   "  |  ..  |",  "   \\    /",   "    ...." }},
    { "Astral Devourer", 7, 2200, 240, 50, 10, 1840, 650, .01f,
      {" ~.  __  .~",  "  ( @  @ )",   " ~\\ >< /~",   "   \\  /",     "    .." }},
    { "Null Walker",     7, 3200, 210, 80,  5, 2128, 750, .012f,
      {"  .[____].",  " .| .  . |.", " .| [  ] |.", "  |  ||  |",  "  |__|__|" }},
    { "Cosmic Horror",   7, 4500, 190, 90,  4, 2300, 800, .012f,
      {" .}\\    /{.",  ". ( .. ) .",  " .|\\  /|.",   " .|_||_|.",   "   .  ." }},
    { "Rift Guardian",   7, 3000, 260, 70,  8, 2185, 780, .014f,
      {" .[.===.].",  " .| @  @ |.", " .| \\  / |.", "  | .||. |",  "  |_|__|_|" }},

    { "Eternal Sentinel",8, 4500, 280, 90,  6, 3335,1050, .01f,
      {"  +[====]+",  " +|| ** ||+", " +||_/\\_||+", "  |+[]]+|",   "  |_|  |_|" }},
    { "Seraphim",        8, 3500, 340, 70, 10, 3105,1000, .01f,
      {" +\\|/  \\|/+", " +( ^  ^ )+", "  +\\    /+",  "   +\\||/+",   "    +||+" }},
    { "Time Weaver",     8, 3000, 370, 55, 12, 3220,1020, .012f,
      {"+~{ @  @ }~+","  +( oo )+",  " +|\\ \\/ /|+", "  +\\|  |/+",  "   + ~~ +" }},
    { "Celestial Dragon",8, 6000, 300,110,  5, 3680,1200, .014f,
      {"+/\\+=+/\\_+", "+\\\\ \\\\=// /+","|| |oo| ||+", " \\_\\ +/_/+",  "  +|__|+" }},
    { "Primordial One",  8, 5000, 350, 85,  8, 3565,1100, .012f,
      {"+{  ____  }+","+(  O  O  )+","+ | \\__/ | +","+  \\|  |/  +","  + ++++ +" }},

    { "Ignis the Molten",5, 4500, 252, 55,  5, 2760,1000, .50f,
      {"  ~\\\\|//~",   " ~{ o  o }~",  " ~|\\\\||//|~", " ~|[FIRE]|~", "  ~|_||_|~" }},
    { "Cryolith",        6, 8000, 364, 80,  6, 4830,1800, .50f,
      {" **/|==|\\**",  " *|| ** ||*", " *|| /\\ ||*", " *|[FROST]*", " *|_|  |_|*"}},
    { "Zhar'Kul the Void",7,14000, 532,100, 7, 8050,3000, .50f,
      {".~{/====\\}~.",".(  @  @  ).",". | \\../ | .",".|[ VOID ]|.",". |_|  |_| ."}},
    { "The Eternal One",  8,22000, 728,130, 8,13800,5000, .50f,
      {"+~{|====|}~+","+|(  **  )|+","+ | \\++/ | +","+|[ETERNAL]+","+ |_|  |_| +"}}
};
